...
func main() {
	...
	datarunning4, err := strava.NewSegmentsService(client).Explore(lathighmid, lonleftmid, lathigh, lonright).ActivityType("running").Do()
	...
	datarunning8, err := strava.NewSegmentsService(client).Explore(latmid, lonleftmid, lathighmid, lonright).ActivityType("running").Do()
	...
	datarunning12, err := strava.NewSegmentsService(client).Explore(latmidlow, lonleftmid, latmid, lonright).ActivityType("running").Do()
	...
	datarunning16, err := strava.NewSegmentsService(client).Explore(latlow, lonleftmid, latmidlow, lonright).ActivityType("running").Do()
	...
	datariding4, err := strava.NewSegmentsService(client).Explore(lathighmid, lonleftmid, lathigh, lonright).ActivityType("riding").Do()
	...
	datariding8, err := strava.NewSegmentsService(client).Explore(latmid, lonleftmid, lathighmid, lonright).ActivityType("riding").Do()
	...
	datariding12, err := strava.NewSegmentsService(client).Explore(latmidlow, lonleftmid, latmid, lonright).ActivityType("riding").Do()
	...
	datariding16, err := strava.NewSegmentsService(client).Explore(latlow, lonleftmid, latmidlow, lonright).ActivityType("riding").Do()
