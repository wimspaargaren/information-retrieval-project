...
### Text processing
Messages are matched and indexed to a sports-related taxonomy to indicate whether the message gives information about a sports activity and which activity that could be.
...
### User Interface
The tweets and regions are sent to the user interface. The different stakeholders can all retrieve their information need from it.
<p align="center">
