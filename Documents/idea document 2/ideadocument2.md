...
# Expected Outcomes
As mentioned earlier in the section objective, the goal of this application is to identify and characterise neighborhoods in Amsterdam. In the following mockup of the user interface (UI), it will become visible how this could look.
<p align="center">
